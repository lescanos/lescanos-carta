...
| Rol | Pantalla de destino |
|---|---|
| `dueno` | Panel admin (`index.html`) |
| `moza` | Servicio de mesas (`table-service.html`) |
| `cocina` | Pantalla de cocina (`kitchen.html`) |
...
```
perfiles       — usuarios del sistema (id, nombre, email, rol, emoji, activo)
...
| `NUM_MESAS` | Cantidad de mesas del local |
